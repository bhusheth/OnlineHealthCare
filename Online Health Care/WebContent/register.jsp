...
<div id="content-container">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <form name="registration" id="registrationForm"  method="post" action="">
        <span class="asterisk">*</span><input type="text" name="fname" placeholder="Firstname" required>
        ...
        <input type="date" name="birthdate" placeholder="Birthdate (YYYY-MM-DD)" required>
        ...
        <span id="ohcresult"></span>
         <span class="asterisk">*</span>
        <input type="password" name="cpass" class="confirmPassword" placeholder="Confirm Password" required>
         <span id="compare-notify-password"></span>
        <input type="radio" value="patient" id="patient" name="user" checked/>
        <label for="patient" class="radio" chec>Patient</label>
        <input type="radio" value="doctor" id="doctor" name="user" />
        <label for="doctor" class="radio" chec>Doctor</label>
        <div id="ExtraField" style="display: none">
        	
        	<input type="text" id="txtHospName" placeholder="Hospital Name" />
        	
        	<input type="text" id="txtHospAddress" placeholder="Hospital Address">
        </div>
        <input type="submit" name="login" id="register-button" class="login login-submit" disabled=true title="Please fill all the * fields above to enable this button." value="Sign Up" tooltip>
      </form>
...
<div  class="infographic-container " style="position: initial;">
