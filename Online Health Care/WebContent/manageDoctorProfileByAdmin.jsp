...
<title>Online Health Care - Manage Doctor Profile </title>
<link rel="stylesheet" type="text/css" href="css/profile.css">
</head>
<body>
<% session= request.getSession();
	doctorProfileVO doctor =(doctorProfileVO) session.getAttribute("user_specific_profile_data");
%>
	...
	<table class=userProfileTable>
  			<tbody >
                ...
                <tr>
      				...
      				<td><input type="submit" class="userProfile-submit" name="editProfileDoctorSubmit" value="Update Changes"> </td>
