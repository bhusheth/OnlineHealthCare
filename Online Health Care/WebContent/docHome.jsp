...
<% }%>
   <div id="main-container">
	    <header class="ohc_shadow">
			...
			<nav>
 			   <a  class="menu-link"  href="docHome.jsp">HOME</a>
      ...
      <div class="sidebar ohc_shadow">
          <table>
                <tr class="profile-picture-container"> 
               		<td class="profile-picture default"> <img src="img/doctor-icon.png" alt ="Default Image for Doctor" /></td>
             	</tr>
             
           		 <!--  <tr class="profile-picture-container"> 
               		<td class="profile-picture doctor-Image"><img src="" alt= "Image of Doctor" /></td>
             	</tr> -->
              ...
              <tr>		
                   <td class="ohc_button sidebar-link active"  goTo="doctordateappointmentController">Appointments  <i class="arrow right"></td>		
              </tr> 
              <tr>
                   <td class="ohc_button sidebar-link"  goTo="<%=request.getContextPath()%>/doctorProfileController">Edit Profile  <i class="arrow right"></td>
              </tr>             
          </table>     
      </div>
      <div class="iframe-container">
          <iframe src= "doctordateappointmentController">
       ...
       <form action="imageUploadController" method="post" enctype="multipart/form-data">
  			<table class="userProfileTable">
			   ...
			   <tr>
       				...
       				<td> <input type="file" name="" id="imgInp" accept="image/*" capture="camera"></td> 
